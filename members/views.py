...
from .runner import get_history, validate
from .utils import create_register_key, need_registeration
...
@need_registeration
def get_hisory_view(request: HttpRequest, member: Member) -> HttpResponse:
